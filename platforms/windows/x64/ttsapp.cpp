// Lightweight 64-bit replacement for the SAPI test application shipped with
...
LRESULT CALLBACK WindowProc(HWND window, UINT message, WPARAM wparam, LPARAM lparam)
{
    ...
    case WM_CREATE: {
        ...
        HWND edit = CreateWindowExW(WS_EX_CLIENTEDGE, L"EDIT",
            L"To jest test 64-bitowego silnika eSpeak.",
...
int WINAPI wWinMain(HINSTANCE instance, HINSTANCE, PWSTR, int show_command)
{
    ...
    window_class.lpszClassName = L"ESpeakTTSApp64";
    RegisterClassExW(&window_class);

    HWND window = CreateWindowExW(0, window_class.lpszClassName,
        L"eSpeak SAPI 5 — test x64", WS_OVERLAPPEDWINDOW,
